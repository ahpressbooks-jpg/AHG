...
import { createEmbeddedCheckout, PriceKey, stripeConfigured } from "@/lib/stripe";

export const dynamic = "force-dynamic";

/** Returns a client_secret for on-site embedded Checkout (subscriptions). */
export async function POST(req: NextRequest) {
  ...
  try {
    const clientSecret = await createEmbeddedCheckout(user, price, base);
